...
const Button = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${href
	? `<a${spread([{ href: escape(href) }, props])}><button${spread([{ class: escape(classes) }, props, { disabled: disabled || null }], "svelte-696es6")}>${icon
		? `${validate_component(Icon, "Icon").$$render($$result, { class: iClasses, small }, {}, { default: () => `${escape(icon)}` })}`
		: ``}
            ${$$slots.default ? $$slots.default({}) : ``}</button></a>`
	: `<button${spread([{ class: escape(classes) }, props, { disabled: disabled || null }], "svelte-696es6")}>${icon
		? `${validate_component(Icon, "Icon").$$render($$result, { class: iClasses, small }, {}, { default: () => `${escape(icon)}` })}`
		: ``}
...
const BotsList = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main class="${"svelte-1mqg5w6"}"><div class="${"textitem px-2 svelte-1mqg5w6"}"><div class="${"rowbalanceitem balancehead svelte-1mqg5w6"}"><label>Баланс</label></div>
...
const BotStatus = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	do {
		...
		$$rendered = `<main class="${"svelte-soetfq"}"><div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><div class="${"foolrow svelte-soetfq"}">${validate_component(TextField, "TextField").$$render(
			$$result,
			{
				label: "Комментарий",
				outlined: true,
    ...
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Текущий режим</label>
            <br>
    ...
    ${botstatus.currentfloor !== 0
		? `<div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><nobr><label class="${"svelte-soetfq"}">Этаж</label>
                    <strong>${escape(floornumber)}</strong>
                    ${escape(low)} - ${escape(hight)}  
                </nobr></div>
            <div class="${"rightitem svelte-soetfq"}" style="${"margin-top: 9px;height:4px; width:100%; background-color: #f5ce54"}">${validate_component(ProgressLinear, "ProgressLinear").$$render($$result, { progress }, {}, {})}</div></div>`
		: ``}
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Цена</label>
            <br>
            <span class="${"inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-bold\n                text-gray-800"}">${escape(last_price)}</span>
            <br></div>
        <div class="${"rightitem rowbalance svelte-soetfq"}"><div class="${"rowbalanceitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Баланс</label></div>
            <div class="${"rowbalanceitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Старт</label>
                <br>
                <span class="${"inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold\n                    text-gray-700"}">${escape(botfinance.startdepo)}</span></div>
            <div class="${"rowbalanceitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Сегодня</label>
                <br>
                <span class="${"inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold\n                    text-gray-700"}">${escape(botfinance.depo)}</span></div></div></div>
    <div class="${"yelowkob svelte-soetfq"}"><div class="${"row svelte-soetfq"}"><div class="${"centereditem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Прибыль всего</label>
                <br>
                <span>${escape(profitsum)}</span>
                <br>
                <span>(${escape(profitsumproc)} %)</span>
                <br></div>
            <div class="${"centereditem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Прибыль сегодня</label>
                <br>
                <span>${escape(salestodaysum.toFixed(botsettings.digitprice))}</span>
                <br>
                <span>(${escape(profittodayproc)} %)</span>
                <br></div></div></div>
    <div class="${"row svelte-soetfq"}"><div class="${"centereditem svelte-soetfq"}"><table class="${"bordernull svelte-soetfq"}"><tr class="${"bordernull svelte-soetfq"}"><td class="${"cellleft svelte-soetfq"}"><label class="${"svelte-soetfq"}">${escape(botsettings.quotacoin)} в наличии</label></td>
                    <td class="${"cellleft bordernull svelte-soetfq"}">${escape(botfinance.quotanal)}</td>
                    <td rowspan="${"2"}" class="${"borderbootom borderleft svelte-soetfq"}">${escape(quotasum.toFixed(botsettings.digitq))}
                        <br>
                        (${escape((last_price * quotasum).toFixed(botsettings.digitq))} ${escape(botsettings.basecoin)})
                    </td></tr>
                <tr><td class="${"borderbootom cellleft svelte-soetfq"}"><label class="${"svelte-soetfq"}">${escape(botsettings.quotacoin)} в ордерах</label></td>
                    <td class="${"borderbootom cellleft svelte-soetfq"}">${escape(botfinance.quotainorders)}</td></tr>
                <tr><td class="${"cellleft svelte-soetfq"}"><label class="${"svelte-soetfq"}">${escape(botsettings.basecoin)} в наличии</label></td>
                    <td class="${"cellleft bordernull svelte-soetfq"}">${escape((botfinance.basenal * 1).toFixed(botsettings.digitprice))}</td>
                    <td rowspan="${"2"}" class="${"borderleft svelte-soetfq"}">${escape(basesum.toFixed(botsettings.digitprice))}</td></tr>
                <tr><td class="${"cellleft svelte-soetfq"}"><label class="${"svelte-soetfq"}">${escape(botsettings.basecoin)} в ордерах</label></td>
                    <td class="${"cellleft svelte-soetfq"}">${escape(botfinance.baseinorders)}</td></tr></table></div></div>
    <div class="${"yelowkob svelte-soetfq"}"><div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Продажи</label>
                <br>
                <label class="${"svelte-soetfq"}">Продажи сегодня</label>
                <br>
                <label class="${"svelte-soetfq"}">Ср. прибыль в сделке</label></div>
            <div class="${"rightitem svelte-soetfq"}">${escape(salesall)}
                <br>
    ...
    <div class="${"yelowkob svelte-soetfq"}"><div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Открытых сделок</label>
                <br>
                <label class="${"svelte-soetfq"}">Средняя цена закупки</label></div>
            <div class="${"rightitem svelte-soetfq"}">${escape(openfloors.count)}
                <br>
                ${escape(openfloors.sprice)} ${escape(botsettings.basecoin)}</div></div></div>
    <br>
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">${escape(botonoff ? "Включен" : "Выключен")}</label>
            <br>
        ...
        <div class="${"rightitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Запрет на закуп</label>
            <br>
            ${validate_component(Switch, "Switch").$$render(
			$$result,
			{
    ...
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}"><label class="${"svelte-soetfq"}">Объем ордера</label>
            <br>
            ~ ${escape(ordersizeinquota)} ${escape(botsettings.quotacoin)}, ${escape(ordersizeinbase)} ${escape(botsettings.basecoin)}</div>
          
        <div class="${"rightitem svelte-soetfq"}">${validate_component(TextField, "TextField").$$render(
			$$result,
			{
				label: "% от депо",
				outlined: true,
    ...
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem svelte-soetfq"}">${validate_component(TextField, "TextField").$$render(
			$$result,
			{
				label: "MA1, мин",
				outlined: true,
    ...
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem padtop5 svelte-soetfq"}"><label class="${"svelte-soetfq"}">Не закупать, если цена больше</label></div>
          
        <div class="${"rightitem svelte-soetfq"}">${validate_component(TextField, "TextField").$$render(
			$$result,
			{
    ...
    <div class="${"row svelte-soetfq"}"><div class="${"leftitem padtop5 svelte-soetfq"}"><label class="${"svelte-soetfq"}">Не закупать, если цена меньше</label></div>
        <div class="${"rightitem svelte-soetfq"}">${validate_component(TextField, "TextField").$$render(
			$$result,
			{
				label: "",
    ...
    <br>
    <br>
    ${validate_component(Button, "Button").$$render($$result, { color: "alert", href: "/" }, {}, { default: () => `Удалить` })}</main>`;
	} while (!$$settled);
...
const css$g = {
	code: ".leftformenu.svelte-140pp2{left:15rem}",
	map: "{\"version\":3,\"file\":\"Scrim.svelte\",\"sources\":[\"Scrim.svelte\"],\"sourcesContent\":[\"<script>\\n  import { fade } from \\\"svelte/transition\\\";\\n  import { quadOut, quadIn } from \\\"svelte/easing\\\";\\n\\n  export let opacity = 0.7;\\n  export let inProps = { duration: 200, easing: quadIn };\\n  export let outProps = { duration: 200, easing: quadOut };\\n</script>\\n\\n<style>\\n.leftformenu{\\n  left: 15rem;\\n}\\n</style>\\n\\n<div\\n  class=\\\"bg-black fixed top-0 z-10 w-full h-full leftformenu\\\"\\n  style=\\\"opacity: {opacity}\\\"\\n  in:fade={inProps}\\n  out:fade={outProps}\\n  on:click />\\n\"],\"names\":[],\"mappings\":\"AAUA,0BAAY,CAAC,AACX,IAAI,CAAE,KAAK,AACb,CAAC\"}"
};
...
const Scrim = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"bg-black fixed top-0 z-10 w-full h-full leftformenu svelte-140pp2"}" style="${"opacity: " + escape(opacity)}"></div>`;
});
...
const css$h = {
	code: ".drawer.svelte-11tyhb6{min-width:15rem;z-index:900}aside.svelte-11tyhb6{height:100vh}.btnsver.svelte-11tyhb6{position:absolute;top:4rem;left:200px;z-index:100}",
	map: "{\"version\":3,\"file\":\"NavigationDrawer.svelte\",\"sources\":[\"NavigationDrawer.svelte\"],\"sourcesContent\":[\"<script>\\n  import { fly } from \\\"svelte/transition\\\";\\n  import { quadIn } from \\\"svelte/easing\\\";\\n  import { Scrim } from \\\"../Util\\\";\\n  import breakpoints from \\\"../../breakpoints\\\";\\n  import { ClassBuilder } from \\\"../../utils/classes.js\\\";\\n  import { stateStore } from '../../../../../src/stores/statebot.js';\\n  const bp = breakpoints();\\n\\n  const classesDefault = \\\"fixed top-0 w-auto drawer overflow-hidden h-full\\\";\\n  const navClassesDefault = `h-full w-full absolute flex w-auto z-1 drawer\\n    pointer-events-auto overflow-y-auto`;\\n\\n  export let right = false;\\n  export let persistent = true;\\n  export let elevation = false;\\n  export let show;\\n  export let classes = classesDefault;\\n  export let navClasses = navClassesDefault;\\n  export let borderClasses = `border-gray-400 ${right ? \\\"border-l\\\" : \\\"border-r\\\"}`;\\n\\n\\n\\n\\n  export let transitionProps = {\\n    duration: 200,\\n    x: -300,\\n    easing: quadIn,\\n    opacity: 1,\\n  };\\n\\n  $: transitionProps.x = right ? 300 : -300;\\n  $: persistent = show = $bp !== \\\"sm\\\";\\n\\n\\n  const cb = new ClassBuilder(classes, classesDefault);\\n\\n  if ($bp === 'sm') show = false;\\n\\n  $: c = cb\\n    .flush()\\n    .add(classes, true, classesDefault)\\n\\n    .add($$props.class)\\n    .add(\\\"right-0\\\", right)\\n    .add(\\\"left-0\\\", !right)\\n    .add(\\\"pointer-events-none\\\", persistent)\\n    .add(\\\"z-50\\\", !persistent)\\n    .add(\\\"elevation-4\\\", elevation)\\n    .add(\\\"z-20\\\", persistent)\\n    .get();\\n\\n  const ncb = new ClassBuilder(navClasses, navClassesDefault);\\n\\n  $: n = ncb\\n    .flush()\\n    .get();\\n\\n</script>\\n\\n<style>\\n  .drawer {\\n    min-width: 15rem;\\n    z-index: 900;\\n  }\\n\\n  aside {\\n    height: 100vh;\\n  }\\n  .btnsver{\\n    position: absolute;\\n    top: 4rem;\\n    left: 200px;\\n    z-index: 100;\\n  }\\n</style>\\n\\n{#if show}\\n<div class=\\\"btnsver\\\"></div>\\n  <aside\\n    class={c}\\n    transition:fly={transitionProps}\\n  >\\n    {#if ($bp == \\\"sm\\\")}\\n      <Scrim on:click={() => show = false} />\\n    {/if}\\n      \\n    <nav\\n      role=\\\"navigation\\\"\\n      class={n}\\n    >\\n  \\n      <div class=\\\"w-full\\\">\\n      \\n        <slot />\\n      </div>\\n    </nav>\\n  </aside>\\n  \\n{/if}\\n\"],\"names\":[],\"mappings\":\"AA6DE,OAAO,eAAC,CAAC,AACP,SAAS,CAAE,KAAK,CAChB,OAAO,CAAE,GAAG,AACd,CAAC,AAED,KAAK,eAAC,CAAC,AACL,MAAM,CAAE,KAAK,AACf,CAAC,AACD,uBAAQ,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,KAAK,CACX,OAAO,CAAE,GAAG,AACd,CAAC\"}"
};

const classesDefault$4 = "fixed top-0 w-auto drawer overflow-hidden h-full";
...
const NavigationDrawer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	transitionProps.x = right ? 300 : -300;
	persistent = show = $bp !== "sm";
	let c = cb.flush().add(classes, true, classesDefault$4).add($$props.class).add("right-0", right).add("left-0", !right).add("pointer-events-none", persistent).add("z-50", !persistent).add("elevation-4", elevation).add("z-20", persistent).get();
	let n = ncb.flush().get();

	return `${show
	? `<div class="${"btnsver svelte-11tyhb6"}"></div>
  <aside class="${escape(null_to_empty(c)) + " svelte-11tyhb6"}">${$bp == "sm"
		? `${validate_component(Scrim$1, "Scrim").$$render($$result, {}, {}, {})}`
		: ``}
      
    <nav role="${"navigation"}" class="${escape(null_to_empty(n)) + " svelte-11tyhb6"}"><div class="${"w-full"}">${$$slots.default ? $$slots.default({}) : ``}</div></nav></aside>`
	: ``}`;
});

/* node_modules/smelte/src/components/AppBar/AppBar.svelte generated by Svelte v3.24.0 */
let classesDefault$5 = "fixed top-0 items-center flex-wrap flex left-0 z-30 p-0 h-16 elevation-3";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
    ...
    <div class="${"pr-2 flex-none"}"><div><svg class="${"fill-current h-6 w-6 svelte-u0xh50"}" viewBox="${"0 0 20 20"}" xmlns="${"http://www.w3.org/2000/svg"}"><title>Menu</title><path d="${"M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"}"></path></svg></div></div>
    <div class="${"flex-grow text-center"}">${escape($stateStore.selectbotname)}</div>

    <div class="${"usermenu flex-none svelte-u0xh50"}">${validate_component(Login, "Login").$$render($$result, {}, {}, {})}</div>
    ...
    <div class="${"flex-none"}">${validate_component(Button, "Button").$$render(
					...
					{
						default: () => `<svg class="${"fill-current w-6 h-6 svelte-u0xh50"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 20 20"}"><path fill-rule="${"evenodd"}" d="${"M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018\n                    0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414\n                    1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1\n                    0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2\n                    0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414\n                    1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0\n                    011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z"}" clip-rule="${"evenodd"}"></path></svg>`
					}
				)}</div>`
			}
		)}
${validate_component(NavigationDrawer, "NavigationDrawer").$$render(
			...
			{
				default: () => `<div class="${"menu svelte-u0xh50"}"><div class="${"flex justify-between"}"><a class="${"text-white no-underline hover:text-white hover:no-underline"}"${add_attribute("aria-current", segment === undefined ? "page" : undefined, 0)} href="${"."}"><svg width="${"95"}" height="${"95"}" viewBox="${"0 0 45 45"}" fill="${"none"}" xmlns="${"http://www.w3.org/2000/svg"}"><g clip-path="${"url(#clip0)"}"><path fill-rule="${"evenodd"}" clip-rule="${"evenodd"}" d="${"M8.96631 8.65552L36.6553 8.65551L36.6553 36.3445L8.96631\n                            36.3445L8.96631 8.65552ZM35.2663 18.3618L35.2663 21.6912H30.9552L30.9552\n                            18.3618L35.2663 18.3618ZM35.2663 34.9937L35.2663 22.571L30.9552\n                            22.571L30.9552 29.7173C30.7305 32.6744 32.6316 34.8393 35.2663\n                            34.9937ZM29.9591 21.7293V18.4119L17.1564 18.4119L17.1564 21.729L21.5194\n                            21.729L21.5194 34.9937H25.8293L25.8293 21.7293L29.9591 21.7293Z"}" fill="${"#F0B90B"}"></path></g><defs><clipPath id="${"clip0"}"><rect width="${"45"}" height="${"45"}" fill="${"white"}"></rect></clipPath></defs></svg></a>
            <div class="${"backknob svelte-u0xh50"}"><div><svg class="${"fill-current h-6 w-6 svelte-u0xh50"}" viewBox="${"0 0 20 20"}" xmlns="${"http://www.w3.org/2000/svg"}"><path d="${"M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414\n                            1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z"}"></path></svg></div></div></div>

        <a class="${"text-current py-4 px-4 flex-none svelte-u0xh50"}"${add_attribute("aria-current", segment === "about" ? "page" : undefined, 0)} href="${"/"}">Главная
        </a>
        <a class="${"text-current py-4 px-4 flex-none svelte-u0xh50"}"${add_attribute("aria-current", segment === "about" ? "page" : undefined, 0)} href="${"about"}">О программе
        </a>

        <a class="${"py-4 px-4 text-current flex-none svelte-u0xh50"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "blog" ? "page" : undefined, 0)} href="${"blog"}">Блог
        </a>

        ${$authStore.status === "in"
				? `<hr>
            <a class="${"py-4 px-4 text-current flex-none svelte-u0xh50"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "blog" ? "page" : undefined, 0)} href="${"/"}">GRID LONG Бот
            </a>
            <a class="${"py-4 px-4 text-current flex-none svelte-u0xh50"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "blog" ? "page" : undefined, 0)} href="${"settings"}">Настройки
            </a>
            <hr>`
				: ``}

        <div class="${"rastyazhka svelte-u0xh50"}"> </div>
        <div class="${"chatpriglos py-4 px-4 text-current flex-none svelte-u0xh50"}">Вступай в наш чат!</div>
        <a class="${"menulast py-4 px-4 text-current flex-none svelte-u0xh50"}" rel="${"prefetch"}"${add_attribute("aria-current", segment === "blog" ? "page" : undefined, 0)} href="${"instruction"}">Инструкция
        </a></div>`
			}
		)}

<div class="${"mainflex svelte-u0xh50"}">${$stateStore.showmenu && $bp != "sm"
		? `<div class="${"zagl svelte-u0xh50"}"> </div>
