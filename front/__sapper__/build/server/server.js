...
const MenuUser = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${escape(null_to_empty(c)) + " svelte-80fr0f"}">${$$slots.activator ? $$slots.activator({}) : ``}
    ${open
